...
| [client-architecture.md](docs/tech/client-architecture.md) | Cocos + PitayaClient + **游戏大厅** |
| [adr/006-game-lobby-dynamic-bundle.md](docs/tech/adr/006-game-lobby-dynamic-bundle.md) | **大厅 API 驱动 + 动态 Bundle** |
| [adr/007-companion-llm.md](docs/tech/adr/007-companion-llm.md) | **智能伴侣 LLM + Tool Calling** |
| [adr/008-game-host-sdk.md](docs/tech/adr/008-game-host-sdk.md) | **独立发布与 GameHostSDK** |
...
| **智能伴侣** | 大厅陪聊 + 推荐开房 + 规则讲解；局内陪玩提示；人设见运营后台「伴侣人设」 |
